...
namespace MEGAbolt
{
    public class MEGAboltInstance
    {
        //public event Action<MEGAboltForm> MEGAboltFormCreated;
        //public virtual void OnMEGAboltFormCreated(MEGAboltForm form)
        //{
        //    if (MEGAboltFormCreated != null) MEGAboltFormCreated(form);
        //}
        ...
        public string MEGAbolt_Version = string.Empty;
