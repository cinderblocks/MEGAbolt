...
namespace MEGAbolt
{
    public partial class frmNotecardEditor : Form
    {
        ...
        public frmNotecardEditor(MEGAboltInstance instance, InventoryItem item)
        {
            InitializeComponent();
        ...
        public frmNotecardEditor(MEGAboltInstance instance, InventoryItem item, bool nreadonly)
        {
            InitializeComponent();
        ...
        public frmNotecardEditor(MEGAboltInstance instance, InventoryNotecard item, Primitive obj)
        {
            InitializeComponent();
