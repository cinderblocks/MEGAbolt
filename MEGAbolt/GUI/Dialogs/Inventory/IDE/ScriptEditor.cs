...
namespace MEGAbolt
{
    public partial class frmScriptEditor : Form
    {
        ...
        public frmScriptEditor(MEGAboltInstance instance, InventoryItem item)
        {
            InitializeComponent();
        ...
        public frmScriptEditor(MEGAboltInstance instance, InventoryLSL item, Primitive obj)
        {
            InitializeComponent();
            Disposed += Script_Disposed;
        ...
        public frmScriptEditor(MEGAboltInstance instance)
        {
            InitializeComponent();
            Disposed += Script_Disposed;
...
using System.Linq;
using System.Text;
using MEGAbolt;  // don't forget to add MEGAbolt as a reference
