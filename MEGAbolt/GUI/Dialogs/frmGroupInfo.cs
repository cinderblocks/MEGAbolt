...
namespace MEGAbolt
{
    public partial class frmGroupInfo : Form
    {
        ...
        public frmGroupInfo(Group group, MEGAboltInstance instance)
        {
            InitializeComponent();
        ...
        public frmGroupInfo(AvatarGroup group, MEGAboltInstance instance)
        {
            InitializeComponent();
        ...
        public frmGroupInfo(UUID groupid, MEGAboltInstance instance)
        {
            InitializeComponent();
        ...
        private void cmdEject_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Select a member to eject!", "MEGAbolt");
            }
        }
        ...
        private void btnInvite_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Select a role to invite to from under the 'Role' tab above first.", "MEGAbolt", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("First you must select a role from the list above.", "MEGAbolt", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
